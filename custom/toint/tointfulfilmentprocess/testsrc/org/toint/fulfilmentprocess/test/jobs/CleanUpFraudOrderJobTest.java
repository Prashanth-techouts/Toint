 ...
 */
package org.toint.fulfilmentprocess.test.jobs;
...
import org.toint.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TointFulfilmentProcessConstants.ORDER_PROCESS_NAME;
