 ...
 */
package org.toint.core.suggestion;
...
import org.toint.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/tointcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
