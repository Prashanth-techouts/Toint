 ...
 */
package org.toint.storefront.controllers.misc;
...
import org.toint.storefront.controllers.ControllerConstants;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "tointstorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("tointstorefront.quick.order.rows.max", 25);
