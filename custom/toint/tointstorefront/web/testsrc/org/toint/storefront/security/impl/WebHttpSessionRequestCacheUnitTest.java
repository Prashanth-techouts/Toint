...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tointstorefront/electronics/en",
						"https://electronics.local:9002/tointstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tointstorefront/electronics/en",
						"https://electronics.local:9002/tointstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tointstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tointstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tointstorefront/electronics/en",
						"https://electronics.local:9002/tointstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tointstorefront",
						"https://electronics.local:9002/tointstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tointstorefront",
						"https://electronics.local:9002/tointstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tointstorefront/electronics/en",
						"https://electronics.local:9002/tointstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
